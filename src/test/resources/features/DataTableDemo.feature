Feature: Banking Operations
  ...
  Scenario: Transfer funds from USD to EUR account
    ...
    And a bank account with account number "B-67890" and balance "$800" in USD
    When I transfer $300 from account "A-12345" to account "B-67890" in USD
    Then the account balance for account "A-12345" should be "$700"
    And the account balance for account "B-67890" should be "$000"

  Scenario: Transfer funds from EUd to GBP account
