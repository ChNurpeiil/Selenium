Feature: Outlines Demo
  ...
  Scenario Outline: Processing an insurance claim for "<coverageType>"
    ...
    Examples:
      ...
      | Health       | H-001   | 500.0  | 2023-07-15 | Medical expenses    | Medical receipts        |
      | Auto         | A-101   | 1000.0 | 2023-07-20 | Car accident repair | Repair invoice          |
      | Home         | Hm-202  | 2000.0 | 2023-07-25 | Roof damage         | Photos, repair estimate |
